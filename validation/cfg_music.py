...
scenario = "I"
card = "delphes_cards_MUSICDet_target.tcl".format(scenario)
...
eff_btag_plots = EfficiencyTaggingBlock("PFJet", "b-tag", mom, eta, gen_cond_btag, [0, 1, 2], "BTag", eff_tag_plots)

eff_ctag_plots = EfficiencyTaggingBlock("PFJet", "c-tag", mom, eta, gen_cond_ctag, [4, 5, 6], "BTag", eff_tag_plots)

eff_tautag_plots = EfficiencyTaggingBlock(
    "PFJet", "tau-tag", mom, eta, gen_cond_tautag, [0, 1, 2], "TauTag", eff_tag_plots
)
